# Exploring Data-Efficient Scene Understanding with Contrastive Scene Contexts
...
For pre-training, one can generate ScanNet Pair data by following code (need to change the TARGET and dataset path accordingly in the script). 

```
cd pretrain/scannet_pair
./preprocess.sh
```
This piece of code first extracts pointcloud from partial frames, and then computes a filelist of overlapped partial frames for each scene. A combined txt file called *overlap30.txt* of filelists of each scene should be put into *TARGET/splits*.
...
|---------------|------------|---------------------------------|-----------------------------------------|--------------------------------------|------------------------------------------|
| 1% scenes     | 29.3       | [download][partition8_4096_60k] | [download][scannet_sem_scene1_weight]   | [download][scannet_sem_scene1_log]   | [download][scannet_sem_scene1_tensorboard]   |
| 5% scenes     | 45.4       | [download][partition8_4096_60k] | [download][scannet_sem_scene5_weight]   | [download][scannet_sem_scene5_log]   | [download][scannet_sem_scene5_tensorboard]   |
| 10% scenes    | 59.5       | [download][partition8_4096_60k] | [download][scannet_sem_scene10_weight]  | [download][scannet_sem_scene10_log]  | [download][scannet_sem_scene10_tensorboard]  |
| 20% scenes    | 64.1       | [download][partition8_4096_60k] | [download][scannet_sem_scene20_weight]  | [download][scannet_sem_scene20_log]  | [download][scannet_sem_scene20_tensorboard]  |
| 100% scenes   | 73.8       | [download][partition8_4096_60k] | [download][scannet_sem_scene100_weight] | [download][scannet_sem_scene100_log] | [download][scannet_sem_scene100_tensorboard] |
| 20 points     | 53.8       | [download][partition8_4096_60k] | [download][scannet_sem_point20_weight]  | [download][scannet_sem_point20_log]  | [download][scannet_sem_point20_tensorboard]  |
| 50 points     | 62.9       | [download][partition8_4096_60k] | [download][scannet_sem_point50_weight]  | [download][scannet_sem_point50_log]  | [download][scannet_sem_point50_tensorboard]  |
| 100 points    | 66.9       | [download][partition8_4096_60k] | [download][scannet_sem_point100_weight] | [download][scannet_sem_point100_log] | [download][scannet_sem_point100_tensorboard] |
| 200 points    | 69.0       | [download][partition8_4096_60k] | [download][scannet_sem_point200_weight] | [download][scannet_sem_point200_log] | [download][scannet_sem_point200_tensorboard] |
...
|---------------|---------------------|-----------------------------|--------------------------------------|-----------------------------------|-------------------------------------------|
| 1% scenes     | 12.3                | [download][partition8_4096_60k] | [download][scannet_ins_scene1_weight]    | [download][scannet_ins_scene1_log]    | [download][scannet_ins_scene1_tensorboard]    |
| 5% scenes     | 33.9                | [download][partition8_4096_60k] | [download][scannet_ins_scene5_weight]    | [download][scannet_ins_scene5_log]    | [download][scannet_ins_scene5_tensorboard]    |
| 10% scenes    | 45.3                | [download][partition8_4096_60k] | [download][scannet_ins_scene10_weight]   | [download][scannet_ins_scene10_log]   | [download][scannet_ins_scene10_tensorboard]   |
| 20% scenes    | 49.8                | [download][partition8_4096_60k] | [download][scannet_ins_scene20_weight]   | [download][scannet_ins_scene20_log]   | [download][scannet_ins_scene20_tensorboard]   |
| 100% scenes   | 59.4                | [download][partition8_4096_60k] | [download][scannet_ins_scene100_weight]  | [download][scannet_ins_scene100_log]  | [download][scannet_ins_scene100_tensorboard]  |
| 20 points     | 27.2                | [download][partition8_4096_60k] | [download][scannet_ins_point20_weight]   | [download][scannet_ins_point20_log]   | [download][scannet_ins_point20_tensorboard]   |
| 50 points     | 35.7                | [download][partition8_4096_60k] | [download][scannet_ins_point50_weight]   | [download][scannet_ins_point50_log]   | [download][scannet_ins_point50_tensorboard]   |
| 100 points    | 43.6                | [download][partition8_4096_60k] | [download][scannet_ins_point100_weight]  | [download][scannet_ins_point100_log]  | [download][scannet_ins_point100_tensorboard]  |
| 200 points    | 50.4                | [download][partition8_4096_60k] | [download][scannet_ins_point200_weight]  | [download][scannet_ins_point200_log]  | [download][scannet_ins_point200_tensorboard]  |
| train + val   | 76.5 (64.8 on test) | [download][partition8_4096_60k] | [download][scannet_ins_benchmark_weight] | [download][scannet_ins_benchmark_log] | [download][scannet_ins_benchmark_tensorboard] |
...
#### Model Zoo
We provide our pre-trained checkpoints (and log file) for reference. You evaluate our pre-trained model by running following code.
...
|-------------------------|-------------|--------------|--------------------------------------|----------------------------------------------|-------------------------------------------|---------------------------------------------------|
| 10% scenes              | 9.9         | 24.7         | [download][partition8_4096_60k]          | [download][scannet_det_scene10_weight]           | [download][scannet_det_scene10_log]           |[download][scannet_det_scene10_tensorboard]            |
| 20% scenes              | 21.4        | 41.4         | [download][partition8_4096_60k]          | [download][scannet_det_scene20_weight]           | [download][scannet_det_scene20_log]           |[download][scannet_det_scene20_tensorboard]            |
| 40% scenes              | 29.5        | 52.0         | [download][partition8_4096_60k]          | [download][scannet_det_scene40_weight]           | [download][scannet_det_scene40_log]           |[download][scannet_det_scene40_tensorboard]            |
| 80% scenes              | 36.3        | 56.3         | [download][partition8_4096_60k]          | [download][scannet_det_scene80_weight]           | [download][scannet_det_scene80_log]           |[download][scannet_det_scene80_tensorboard]            |
| 100% scenes             | 39.3        | 59.1         | [download][partition8_4096_60k]          | [download][scannet_det_scene100_weight]          | [download][scannet_det_scene100_log]          |[download][scannet_det_scene100_tensorboard]           |
| 100% scenes (PointNet++)| 39.2        | 62.5         | [download][partition8_4096_15k_pointnet2]| [download][scannet_det_scene100_weight_pointnet2]| [download][scannet_det_scene100_log_pointnet2]|[download][scannet_det_scene100_tensorboard_pointnet2] |
| 1 bboxes                | 30.3        | 54.5         | [download][partition8_4096_60k]          | [download][scannet_det_bbox1_weight]             | [download][scannet_det_bbox1_log]             |[download][scannet_det_bbox1_tensorboard]              |
| 2 bboxes                | 32.4        | 55.3         | [download][partition8_4096_60k]          | [download][scannet_det_bbox2_weight]             | [download][scannet_det_bbox2_log]             |[download][scannet_det_bbox2_tensorboard]              |
| 4 bboxes                | 34.6        | 58.9         | [download][partition8_4096_60k]          | [download][scannet_det_bbox4_weight]             | [download][scannet_det_bbox4_log]             |[download][scannet_det_bbox4_tensorboard]              |
| 7 bboxes                | 35.9        | 59.7         | [download][partition8_4096_60k]          | [download][scannet_det_bbox7_weight]             | [download][scannet_det_bbox7_log]             |[download][scannet_det_bbox7_tensorboard]              |
...
| Training Data   | mIoU (val) | Initialization                 |  Pre-trained Model              |Logs                        | Tensorboard                          |
|-----------------|------------|--------------------------------|---------------------------------|----------------------------|--------------------------------------|
| 100% scenes     | 72.2       |[download][partition8_4096_20k] | [download][stanford_sem_weight] |[download][stanford_sem_log]| [download][stanford_sem_tensorboard]|
...
|-------------------|-------------------|---------------------------------|---------------------------------|-----------------------------|-------------------------------------|
| 100% scenes       | 63.4              | [download][partition8_4096_20k] | [download][stanford_ins_weight] |[download][stanford_ins_log] | [download][stanford_ins_tensorboard]|
...
|----------------|-------------------|-------------------|----------------------------------|------------------------------------|-----------------------------|------------------------------------| 
| 100% scenes    | 36.4              |    58.9           | [download][partition4_4096_100k] | [download][sunrgbd_det_weight]     | [download][sunrgbd_det_log] |[download][sunrgbd_det_tensorboard] |
...
[scannet_sem_scene1_tensorboard]:   http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/scene1/tensorboard.tar.gz
[scannet_sem_scene5_tensorboard]:   http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/scene5/tensorboard.tar.gz
[scannet_sem_scene10_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/scene10/tensorboard.tar.gz
[scannet_sem_scene20_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/scene20/tensorboard.tar.gz
[scannet_sem_scene100_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/scene100/tensorboard.tar.gz
...
[scannet_sem_point20_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/point20/tensorboard.tar.gz
[scannet_sem_point50_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/point50/tensorboard.tar.gz
[scannet_sem_point100_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/point100/tensorboard.tar.gz
[scannet_sem_point200_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_semseg/point200/tensorboard.tar.gz
...
[scannet_ins_scene1_tensorboard]:   http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/scene1/tensorboard.tar.gz
[scannet_ins_scene5_tensorboard]:   http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/scene5/tensorboard.tar.gz
[scannet_ins_scene10_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/scene10/tensorboard.tar.gz
[scannet_ins_scene20_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/scene20/tensorboard.tar.gz
[scannet_ins_scene100_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/scene100/tensorboard.tar.gz
...
[scannet_ins_point20_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/point20/tensorboard.tar.gz
[scannet_ins_point50_tensorboard]:  http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/point50/tensorboard.tar.gz
[scannet_ins_point100_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/point100/tensorboard.tar.gz
[scannet_ins_point200_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_insseg/point200/tensorboard.tar.gz
...
[scannet_det_scene10_tensorboard]:            http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/scene10/tensorboard.tar.gz
[scannet_det_scene20_tensorboard]:            http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/scene20/tensorboard.tar.gz
[scannet_det_scene40_tensorboard]:            http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/scene40/tensorboard.tar.gz
[scannet_det_scene80_tensorboard]:            http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/scene80/tensorboard.tar.gz
[scannet_det_scene100_tensorboard]:           http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/scene100/tensorboard.tar.gz
[scannet_det_scene100_tensorboard_pointnet2]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/scene100_pointnet2/tensorboard.tar.gz
...
[scannet_det_bbox1_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/bbox1/tensorboard.tar.gz
[scannet_det_bbox2_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/bbox2/tensorboard.tar.gz
[scannet_det_bbox4_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/bbox4/tensorboard.tar.gz
[scannet_det_bbox7_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/scannet_det/bbox7/tensorboard.tar.gz
...
[stanford_sem_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/stanford_semseg/tensorboard.tar.gz
...
[stanford_ins_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/stanford_insseg/tensorboard.tar.gz
...
[sunrgbd_det_tensorboard]: http://kaldir.vc.in.tum.de/3dsis/contrastive_scene_contexts/finetune/sunrgbd_det/tensorboard.tar.gz
